...
public class ListRowPresenter extends OpenPresenter {
    ...
    /**
     * 你可以设置自己的 头 com.kunyuanzhihui.ifullcaretv.com.kunyuanzhihui.ifullcaretv.presenter, 还有横向 com.kunyuanzhihui.ifullcaretv.com.kunyuanzhihui.ifullcaretv.presenter.
     *
     * @param items
     * @param headPresenter
     * @param listPresenter
